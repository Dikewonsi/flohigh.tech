         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-3 col-sm-6 ftr-brand-pp">
                  <a class="navbar-brand mt30 mb25 f-dark-logo" href="#"> <img src="images/dark-logo1.png" style="width:200px; margin-bottom:-100px; margin-left:-50px;" alt="Logo"/></a>
                  <a class="navbar-brand mt30 mb25 f-white-logo" href="#"> <img src="images/flohigh-logo.png" style="width:100px; margin-bottom:-100px;  margin-left:-50px;" alt="Logo" /></a>
                  <br><br><br><br><br>
