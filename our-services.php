						...
						<div class="row justify-content-center">
							<div class="col-lg-7">
								<div class="bread-titlev2">
									<h1 class="wow fadeInUp" data-wow-delay=".2s">Empowering digital success, one solution at a time.</h1>
									<p class="mt20 wow fadeInUp" data-wow-delay=".4s">We offer a comprehensive suite of digital solutions designed to help businesses thrive in the digital age. </p>
									<a href="contact-us.php" class="btn-main bg-btn2 lnk mt20 wow zoomInDown" data-wow-delay=".6s">Contact Us <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row small t-ctr mt0">
							...
							<div class="col-lg-3 col-sm-6">
								<div class="statistics">
									...
									<div class="statnumb">
										<span class="counter">750</span><span>k</span>
										<p>Hours Worked</p>
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-lg-4">
								<div class="image-block upset bg-shape wow fadeIn">
									<img src="images/about/our-services.jpg" alt="image" class="img-fluid"/>
								</div>
							</div>
							<div class="col-lg-8 block-1">
								<div class="common-heading text-l pl25">
									...
									<p>Welcome to Flohigh Technology, where digital innovation meets excellence. As a leading provider of comprehensive digital solutions, we are committed to helping businesses thrive in the ever-evolving digital landscape. Our team of skilled professionals brings together expertise in web design, development, branding, marketing, and more to deliver tailored solutions that drive growth, foster innovation, and create lasting value for our clients.</p>
									<p>We understand that navigating the digital realm can be daunting. With countless options available, choosing the right digital partner is crucial for the success of your business.</p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row justify-content-center">
							<div class="col-lg-6">
								<div class="common-heading ptag">
									<span>Service</span>
									<h2>Our Services</h2>
									<p class="mb30">At Flohigh Technology, we offer a comprehensive suite of digital solutions designed to help businesses thrive in the digital age. From web design and development to branding, marketing, and beyond, we have the expertise and experience to meet all your digital needs. Explore our services below</p>
								</div>
							</div>
						</div>
						<div class="row upset link-hover">
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".2s">
								<div class="s-block">
									...
									<h4>Web Design</h4>
									<p>Elevate your online presence with our custom web design services. Our expert designers will work closely with you to create a visually stunning and user-friendly website that reflects your brand identity and captivates your audience.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".4s">
								<div class="s-block">
									...
									<p>Bring your website to life with our web development services. Our skilled developers will build a robust and scalable website using the latest technologies and best practices, ensuring optimal performance and functionality.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".6s">
								<div class="s-block">
									...
									<p>Transform your ideas into reality with our app development services. Whether you need a mobile app, web app, or cross-platform solution, our experienced team will create a custom application that meets your unique requirements and drives user engagement.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".8s">
								<div class="s-block">
									...
									<p>Make a lasting impression with our graphic design services. From logos and branding materials to marketing collateral and social media graphics, our talented designers will help you stand out from the competition with eye-catching visuals.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay="1s">
								<div class="s-block">
									...
									<p>Establish a strong and memorable brand identity with our branding solutions. Our comprehensive services include brand strategy, logo design, visual identity development, and more, helping you create a cohesive brand experience that resonates with your target audience.</p>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeInUp" data-wow-delay="1.2s">
								<div class="s-block">
									...
									<p>Optimize your online store for success with our e-commerce solutions. From platform selection and design customization to payment integration and conversion optimization, our experts will help you create a seamless and profitable online shopping experience for your customers.</p>
								</div>
							</div>
						</div>
					...
					<div class="container">
							...
							<div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>Consistent solutions tailored to your needs, ensuring peace of mind.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>Recommended by those you trust and admire.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>Expertise across all digital aspects, ensuring capable hands.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>Warmth and professionalism in every interaction.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>Top-notch quality, punctual delivery - our standard.</p>
									</div>
								</div>
							</div>
							<div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
								<div class="s-block wide-sblock">
									...
									<div class="s-block-content">
										...
										<p>Transparent, collaborative, and satisfying project communication.</p>
									</div>
								</div>
							</div>
						</div>
						<div class="-cta-btn mt70">
							<div class="free-cta-title v-center wow zoomInDown" data-wow-delay="1.8s">
								...
								<a href="contact-us.php" class="btn-main bg-btn2 lnk">Contact Us Now<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
							</div>
						</div>
					</div>
				</section>
						...
						<div class="container">
							...
							<div class="col-lg-8">
								<div class="common-heading">
									...
									<a href="contact-us.php" class="btn-main bg-btn2 lnk">Estimate Project Cost <i class="fas fa-chevron-right fa-icon"></i></a>
